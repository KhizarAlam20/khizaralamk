...
const ProjectSection: React.FC = () => {
  ...
  const projects: Project[] = [
    {
      id: 2,
      title: "Music App Logo Design",
      type: "design",
      image:
        "https://res.cloudinary.com/dityjpdl6/image/upload/w_800,dpr_auto,f_auto,q_auto/zjgqltpwapkbqzcg6vuc.jpg",
      link: "#",
    },
    {
      id: 3,
    ...
    {
      id: 4,
      title: "icecream brand logo design",
      type: "design",
      image:
        "https://res.cloudinary.com/dityjpdl6/image/upload/w_800,dpr_auto,f_auto,q_auto/v1745246092/ghyiv4wjsqevnlum25qy.jpg",
      link: "#",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      type: "design",
      image:
        "https://res.cloudinary.com/dityjpdl6/image/upload/w_800,dpr_auto,f_auto,q_auto/v1745246150/hinbcw7k8gm92mtbiqg1.jpg",
      link: "#",
    },
    {
      id: 11,
      title: "wallpaper app",
      type: "design",
      image:"https://res.cloudinary.com/dityjpdl6/image/upload/w_800,dpr_auto,f_auto,q_auto/v1745250579/n4tsotzb2h3ahmovootc.jpg",
      link: "#",
    },
    {
      id: 12,
            ...
            >
              ...
              <div className="absolute z-20 transition-opacity duration-500 ease-in-out delay-150 opacity-0 bottom-4 left-4 group-hover:opacity-100">
                <div className="bg-theme-primary px-3 py-1 rounded-tr-[3px] inline-block max-w-full">
                  <span
                    className={`text-sm font-semibold font-display whitespace-nowrap ${
